...
class StoryMenuState extends MusicBeatState
{
	...
	var weekData:Array<Dynamic> = [
		...
		['Senpai', 'Roses', 'Thorns'],
		['Ugh', 'Guns', 'Stress'],
		['No-Turning-Back', 'Purple-Trauma', 'Demons-Lair']
	];
		...
		for (char in 0...3)
		{
			...
			switch (weekCharacterThing.character)
			{
				...
				case 'parents-christmas':
					...
					weekCharacterThing.updateHitbox();
				case 'circles':
					weekCharacterThing.setGraphicSize(Std.int(weekCharacterThing.width * 1.7));
					weekCharacterThing.updateHitbox();
			}
	...
	function updateText()
	{
		...
		switch (grpWeekCharacters.members[0].animation.curAnim.name)
		{
			...
			case 'circles':
				...
				grpWeekCharacters.members[0].offset.set(200, 150);
